package com.gq.container.log4j;
...
public class Log4jContainer implements Container {
    ...
    public static final String CONTAINER_LOG4J_STATE = "container.log4j.state";
    ...
    public void start() {
        String containerLog4jState = ConfigUtils.getProperty(CONTAINER_LOG4J_STATE);
        if (containerLog4jState != null && "on".equals(containerLog4jState)) {
            String file = "../logs/log4j.log";
